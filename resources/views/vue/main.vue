<template>
  <div>
    ...
    <!-- AYIN SEÇKİLERİ -->
    <v-row v-if="monthly_award.lenght">
      <v-col>
    ...
    <v-row id="compLogo" class="py-5">
      ...
      <v-col cols="6" sm="3" class="d-flex justify-content-center align-items-center">
        <img class="imgchangeColor" :src="'images/logo/kits.png'" alt height="50" width="auto" />
      </v-col>
      <v-col cols="6" sm="3" class="d-flex justify-content-center align-items-center">
        <img class="imgchangeColor" :src="'images/logo/tokat.png'" alt height="50" width="auto" />
      </v-col>
      <v-col cols="6" sm="3" class="d-flex justify-content-center align-items-center">
        <img class="imgchangeColor" :src="'images/logo/ulakbim.png'" alt height="50" width="auto" />
      </v-col>
      <v-col cols="12" class="mt-5 d-flex justify-content-center align-items-center">
        <img :src="'images/logo/google-play.png'" alt height="55" width="auto" class="mr-2" />
...
export default {
  ...
  methods: {
    ...
    getMontlyAwardDate() {
      this.date = new Date().toLocaleString("tr").split(" ")[0].split(".");
      this.date[0] = "01";
  ...
  mounted() {
    darkMode
      ? $("#compLogo").find(".imgchangeColor").toggleClass("whiteBG")
      : "";
  },
  watch: {},
  created() {
