            ...
            <v-card-text>
              ...
              <v-list dense class="pa-0 ma-0">
                ...
                >
                  ...
                  <v-icon small left color="gray">mdi-account-hard-hat</v-icon>
                  <span class="body-2">{{ person.ad }} {{ person.soyad }}</span>
                </v-list-item>
              </v-list>
            </v-card-text>
            <v-card-actions>
              <v-btn small text color="secondary" @click="selectedOpen = false"
                >Kapat</v-btn
              >
            </v-card-actions>
          </v-card>
